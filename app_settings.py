...
# copiar (com '/' no final).
INPUT_FOLDER = '~/Dropbox/Aplicativos/Filemaker_backups/NPK-Backup/db-backup/'

# Caminho para o arquivo zip temporário a criar para o upload (com '/' no final).
ARCHIVE_PATH = '~/Dropbox/Aplicativos/Filemaker_backups/tmp/'
...
BACKUP_LOG_FILE = '~/Dropbox/Aplicativos/Filemaker_backups/tmp/backup-log.pkl'
